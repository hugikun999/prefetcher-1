...
void naive_transpose_reverse(int *src, int *dst, int w, int h)
{
    for (int x = 0; x < h; x++)
        for (int y = 0; y < w; y++)
            *(dst + y * h + x) = *(src + x * w + y);
...
void sse_transpose_lddqu(int *src, int *dst, int w, int h)
{
    for (int x = 0; x < w; x += 4) {
        for (int y = 0; y < h; y += 4) {
...
void sse_transpose_load(int *src, int *dst, int w, int h)
{
    for (int x = 0; x < w; x += 4) {
        for (int y = 0; y < h; y += 4) {
...
void sse_prefetch_transpose_dist(int *src, int *dst, int w, int h, int pfdist)
{
    for (int x = 0; x < w; x += 4) {
        for (int y = 0; y < h; y += 4) {
